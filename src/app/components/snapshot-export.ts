...
<head>
  ...
  <title>${esc(entry.label)}: heur project snapshot</title>
  <style>
...
<div class="wrap">
  <div class="header">
    <div style="font-size:12px;color:#6b7280;margin-bottom:4px">heur project · Heuristic pre-screen snapshot</div>
  ...
  <footer>
    Generated by heur project on ${date} · Heuristic pre-screen only · Runs stay on your device, no cloud, no account.
