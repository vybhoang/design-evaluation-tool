...
<head>
  ...
  <title>${esc(entry.label)} — Cognition snapshot</title>
  <style>
...
<div class="wrap">
  <div class="header">
    <div style="font-size:12px;color:#6b7280;margin-bottom:4px">Cognition · Heuristic pre-screen snapshot</div>
  ...
  <footer>
    Generated by Cognition on ${date} · Heuristic pre-screen only · Runs stay on your device — no cloud, no account.
